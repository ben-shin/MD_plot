# MD_plot
Some scripts I use to plot collective variables

global_track.py creates a smoothed timeseries, bar plot of the mean of phenotypes with error bars, and a histogram.
You can modify the script to track RMSD, center of mass to center of mass distances, and Rg.
